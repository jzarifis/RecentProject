...
import "https://raw.githubusercontent.com/jzarifis/RecentProject/develop/contracts/blockReward/BlockReward.sol";
...
contract RecentBlockReward is BlockReward {
	...
	function testCalculatedReward(uint blockNumber) public returns (uint256) {
		return calculateReward (blockNumber);
	}


	function testReward(address[] benefactors, uint16[] kind) public returns (address[], uint256[]) {
